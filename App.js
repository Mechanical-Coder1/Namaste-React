...
const Header = () => {
    return(
        <div className='header-container'>
            <div>
                <img className='logo' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8FucpqaMfHvX0WjB5Mn2xbD1TexPPzQKutrOnWOVI&s'></img>
            </div>
...
const resList =  [
    {
      ...
      "analytics": {
        "context": "seo-data-33864d57-82d1-42fb-8803-528749682566"
      },
      "cta": {
        "link": "https://www.swiggy.com/restaurants/lucky-multicuisine-restaurant-raj-bhavan-quarters-colony-somajiguda-hyderabad-100942",
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-10-26 02:30:00",
          "opened": true
        },
        "badges": {
    ...
    },
    {
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/hilton-restaurant-somajiguda-and-khairtabad-hyderabad-312800",
        "text": "RESTAURANT_MENU",
        "type": "WEBLINK"
      },
      "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
...
const RestaurentCard = (props) => {
    ...
    <div className='res-card'>
        <img className='res-img' alt='food-logo' src={'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/'+ cloudinaryImageId}  />
...
const Body = () =>{
    ...
    <div className='body-container'>
        <div>
            ...
            {/* <RestaurentCard resList={resList[0]} /> */}
            {
                resList.map(restaurent=><RestaurentCard key={restaurent.info.id} resList={restaurent} />)
            }
            </div>
        </div>
    </div>)
